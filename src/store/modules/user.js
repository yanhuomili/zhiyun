  ...
  actions: {
    ...
    async LoginByUsername({ commit }, userInfo) {
      try {
        ...
        // commit('SET_TRANSITIONROLES', [user.userRoleVOList[0].roleVO.name])
    ...
    async GetUserInfo({ commit, state }) {
      ...
      //   // commit('SET_INTRODUCTION', data.introduction)
      //   // response.data = data
      //   // if (state.transitionRoles.length === 0) {
      //   //   state.transitionRoles = ['default']
      //   // }
      //   commit('SET_ROLES', state.transitionRoles)
      //   const response = {
      //     data: {
      //       role: state.transitionRoles
      //     }
      //   }
      //   resolve(response)
